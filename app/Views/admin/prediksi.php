    ...
    <div class="mb-3">
        <div class="card border-primary shadow-sm">
            <div class="card-body p-3">
                <form action="#" method="post" class="form-inline row g-3 align-items-center">
                    <div class="col-auto">
        ...
        <div class="col-md-3">
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800">63,500</div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800">12,700</div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
