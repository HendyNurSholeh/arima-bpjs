...
<head>
    ...
    <link href="/assets2/vendor2/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
    ...
    <link href="/assets2/vendor2/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <script src="/assets2/vendor2/jquery/jquery.min.js"></script>
    <script src="/assets2/vendor2/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="/assets2/vendor2/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="/assets2/js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="/assets2/vendor2/chart.js/Chart.min.js"></script>
    ...
    <!-- Page level plugins -->
    <script src="/assets2/vendor2/datatables/jquery.dataTables.min.js"></script>
    <script src="/assets2/vendor2/datatables/dataTables.bootstrap4.min.js"></script>
